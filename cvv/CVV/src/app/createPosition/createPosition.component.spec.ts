...
describe('createPositionComponent', () => {
  ...
  let mockcreatePositionService;
  let mockDataService

  beforeEach(async(() => {

    mockcreatePositionService = sinon.createStubInstance(createPositionService);
    mockcreatePositionService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: createPositionService, useValue: mockcreatePositionService },
